...
def write_sorc(hdfpath, savepath, limit):
    ...
    soup = BeautifulSoup("<html><head><style></style></head><body><h3></h3><div class=container></div><h3></h3><div class=container></div></body></html>", 'html.parser')
    ...
    soup.style.append(".col0{min-width:12.2vw !important;, width:12.2vw !important;}")
    soup.style.append(".col1{min-width:3vw !important; width:3vw !important;}")
